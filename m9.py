# m9.py - Chat API
from flask import Blueprint, request, jsonify, session  # <-- jsonify اینجا اضافه شد
import time
    ...
    def register_routes(self, bp):
        ...
        def chat():
            ...
            if local_results and local_results[0]['score'] > 0.7:
                ...
                if hasattr(self.knowledge, 'update_feedback'):
            ...
            # یادگیری از تعامل
            if hasattr(self.learning, 'learn_from_query'):
        ...
        def trending():
            """موضوعات داغ"""
            return jsonify({
                'trending': self.learning.get_trending() if hasattr(self.learning, 'get_trending') else [],
                'stats': self.learning.popular_queries.most_common(10) if hasattr(self.learning, 'popular_queries') else []
            })
